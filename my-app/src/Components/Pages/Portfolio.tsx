    ...
    return (
        <div style = {style} className="d-flex flex-column align-items-center p-2">
            ...
            <div  className="d-flex flex-column">
                <PortfolioHolder title="Autafi" description='Place where users find buyers and sellers for their cars and parts' language= "Node.js, JavaScript" frameworks='Vue.js, Express.js, MongoDB' link="www.autafi.com" imageSource="../../portfolio/autafi.com.png"/>
                <PortfolioHolder title="philburney.com" description='The website you are looking at!  I decided to create a website that would allow potential employers to view my skills in full-stack development.  To view the source code, look under "About The Website".' language= "Node.js, TypeScript" frameworks='React' link="www.philburney.com" imageSource="../../images/oilpan.jpg"/>
                ...
                language= "Java" frameworks='Processing' link="https://github.com/phil-burney/Movement" imageSource="../../portfolio/movementjava.gif"/>
            </div>
